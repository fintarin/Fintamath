...
TEST(ComplexTests, stringConstructorTest) {
  ...
  EXPECT_THAT(
      ...
      testing::ThrowsMessage<InvalidInputException>(
          testing::StrEq(R"(Unable to parse a Complex from "")")));
  EXPECT_THAT(
      [] { Complex("--10"); },
      testing::ThrowsMessage<InvalidInputException>(
          testing::StrEq(R"(Unable to parse a Complex from "--10")")));
  EXPECT_THAT(
      [] { Complex("test"); },
      testing::ThrowsMessage<InvalidInputException>(
          testing::StrEq(R"(Unable to parse a Complex from "test")")));
  EXPECT_THAT(
      [] { Complex("+"); },
      testing::ThrowsMessage<InvalidInputException>(
          testing::StrEq(R"(Unable to parse a Complex from "+")")));
  EXPECT_THAT(
      ...
      testing::ThrowsMessage<InvalidInputException>(
          testing::StrEq(R"(Unable to parse a Complex from "939849.0-0023")")));
  EXPECT_THAT(
      [] { Complex("a"); },
      testing::ThrowsMessage<InvalidInputException>(
          testing::StrEq(R"(Unable to parse a Complex from "a")")));
  EXPECT_THAT(
      [] { Complex("a.1"); },
      testing::ThrowsMessage<InvalidInputException>(
          testing::StrEq(R"(Unable to parse a Complex from "a.1")")));
  EXPECT_THAT(
      [] { Complex("1.a"); },
      testing::ThrowsMessage<InvalidInputException>(
          testing::StrEq(R"(Unable to parse a Complex from "1.a")")));
  EXPECT_THAT(
      [] { Complex("1a.1"); },
      testing::ThrowsMessage<InvalidInputException>(
          testing::StrEq(R"(Unable to parse a Complex from "1a.1")")));
  EXPECT_THAT(
      [] { Complex("1.1a"); },
      testing::ThrowsMessage<InvalidInputException>(
          testing::StrEq(R"(Unable to parse a Complex from "1.1a")")));
  EXPECT_THAT(
      [] { Complex(".1."); },
      testing::ThrowsMessage<InvalidInputException>(
          testing::StrEq(R"(Unable to parse a Complex from ".1.")")));
  EXPECT_THAT(
      [] { Complex("."); },
      testing::ThrowsMessage<InvalidInputException>(
          testing::StrEq(R"(Unable to parse a Complex from ".")")));
  EXPECT_THAT(
      [] { Complex("--10.-1"); },
      testing::ThrowsMessage<InvalidInputException>(
          testing::StrEq(R"(Unable to parse a Complex from "--10.-1")")));
  EXPECT_THAT(
      [] { Complex("10.-1"); },
      testing::ThrowsMessage<InvalidInputException>(
          testing::StrEq(R"(Unable to parse a Complex from "10.-1")")));
  EXPECT_THAT(
      [] { Complex("1-0.1"); },
      testing::ThrowsMessage<InvalidInputException>(
          testing::StrEq(R"(Unable to parse a Complex from "1-0.1")")));
  EXPECT_THAT(
      [] { Complex("10-.1"); },
      testing::ThrowsMessage<InvalidInputException>(
          testing::StrEq(R"(Unable to parse a Complex from "10-.1")")));
  ...
  EXPECT_THAT(
      [] { Complex("1.10.1"); },
      testing::ThrowsMessage<InvalidInputException>(
          testing::StrEq(R"(Unable to parse a Complex from "1.10.1")")));
  EXPECT_THAT(
      [] { Complex("0II"); },
      testing::ThrowsMessage<InvalidInputException>(
          testing::StrEq(R"(Unable to parse a Complex from "0II")")));
}
...
TEST(ComplexTests, divideAssignmentOperatorTest) {
  ...
  EXPECT_THAT(
      ...
      testing::ThrowsMessage<UndefinedException>(
          testing::StrEq(R"(Undefined "0" / "0" (division by zero))")));
  EXPECT_THAT(
