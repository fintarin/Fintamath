...
TEST(RationalTests, stringConstructorTest) {
  ...
  EXPECT_THAT(
      ...
      testing::ThrowsMessage<InvalidInputException>(
          testing::StrEq(R"(Unable to parse a Rational from "")")));
  EXPECT_THAT(
      [] { Rational("--10"); },
      testing::ThrowsMessage<InvalidInputException>(
          testing::StrEq(R"(Unable to parse a Rational from "--10")")));
  EXPECT_THAT(
      [] { Rational("test"); },
      testing::ThrowsMessage<InvalidInputException>(
          testing::StrEq(R"(Unable to parse a Rational from "test")")));
  EXPECT_THAT(
      [] { Rational("+"); },
      testing::ThrowsMessage<InvalidInputException>(
          testing::StrEq(R"(Unable to parse a Rational from "+")")));
  EXPECT_THAT(
      ...
      testing::ThrowsMessage<InvalidInputException>(
          testing::StrEq(R"(Unable to parse a Rational from "939849.0-0023")")));
  EXPECT_THAT(
      [] { Rational("a"); },
      testing::ThrowsMessage<InvalidInputException>(
          testing::StrEq(R"(Unable to parse a Rational from "a")")));
  EXPECT_THAT(
      [] { Rational("."); },
      testing::ThrowsMessage<InvalidInputException>(
          testing::StrEq(R"(Unable to parse a Rational from ".")")));
  EXPECT_THAT(
      [] { Rational("a.1"); },
      testing::ThrowsMessage<InvalidInputException>(
          testing::StrEq(R"(Unable to parse a Rational from "a.1")")));
  EXPECT_THAT(
      [] { Rational("1.a"); },
      testing::ThrowsMessage<InvalidInputException>(
          testing::StrEq(R"(Unable to parse a Rational from "1.a")")));
  EXPECT_THAT(
      [] { Rational("1a.1"); },
      testing::ThrowsMessage<InvalidInputException>(
          testing::StrEq(R"(Unable to parse a Rational from "1a.1")")));
  EXPECT_THAT(
      [] { Rational("1.1a"); },
      testing::ThrowsMessage<InvalidInputException>(
          testing::StrEq(R"(Unable to parse a Rational from "1.1a")")));
  EXPECT_THAT(
      [] { Rational(".1."); },
      testing::ThrowsMessage<InvalidInputException>(
          testing::StrEq(R"(Unable to parse a Rational from ".1.")")));
  EXPECT_THAT(
      [] { Rational("--10.-1"); },
      testing::ThrowsMessage<InvalidInputException>(
          testing::StrEq(R"(Unable to parse a Rational from "--10.-1")")));
  EXPECT_THAT(
      [] { Rational("10.-1"); },
      testing::ThrowsMessage<InvalidInputException>(
          testing::StrEq(R"(Unable to parse a Rational from "10.-1")")));
  EXPECT_THAT(
      [] { Rational("1-0.1"); },
      testing::ThrowsMessage<InvalidInputException>(
          testing::StrEq(R"(Unable to parse a Rational from "1-0.1")")));
  EXPECT_THAT(
      [] { Rational("10-.1"); },
      testing::ThrowsMessage<InvalidInputException>(
          testing::StrEq(R"(Unable to parse a Rational from "10-.1")")));
  ...
  EXPECT_THAT(
      [] { Rational("1.10.1"); },
      testing::ThrowsMessage<InvalidInputException>(
          testing::StrEq(R"(Unable to parse a Rational from "1.10.1")")));
}
...
TEST(RationalTests, integerIntegerConstructorTest) {
  ...
  EXPECT_THAT(
      ...
      testing::ThrowsMessage<UndefinedException>(
          testing::StrEq(R"(Undefined "23070" / "0" (division by zero))")));
}
...
TEST(RationalTests, divideAssignmentOperatorTest) {
  ...
  EXPECT_THAT(
      ...
      testing::ThrowsMessage<UndefinedException>(
          testing::StrEq(R"(Undefined "369/5" / "0" (division by zero))")));
}
