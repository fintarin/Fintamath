...
TEST(RationalTests, stringConstructorTest) {
  ...
  EXPECT_THAT(
      ...
      testing::ThrowsMessage<InvalidInputException>(
          testing::StrEq(R"(Invalid Rational "")")));
  EXPECT_THAT(
      [] { Rational("--10"); },
      testing::ThrowsMessage<InvalidInputException>(
          testing::StrEq(R"(Invalid Rational "--10")")));
  EXPECT_THAT(
      [] { Rational("test"); },
      testing::ThrowsMessage<InvalidInputException>(
          testing::StrEq(R"(Invalid Rational "test")")));
  EXPECT_THAT(
      [] { Rational("+"); },
      testing::ThrowsMessage<InvalidInputException>(
          testing::StrEq(R"(Invalid Rational "+")")));
  EXPECT_THAT(
      ...
      testing::ThrowsMessage<InvalidInputException>(
          testing::StrEq(R"(Invalid Rational "939849.0-0023")")));
  EXPECT_THAT(
      [] { Rational("a"); },
      testing::ThrowsMessage<InvalidInputException>(
          testing::StrEq(R"(Invalid Rational "a")")));
  EXPECT_THAT(
      [] { Rational("."); },
      testing::ThrowsMessage<InvalidInputException>(
          testing::StrEq(R"(Invalid Rational ".")")));
  EXPECT_THAT(
      [] { Rational("a.1"); },
      testing::ThrowsMessage<InvalidInputException>(
          testing::StrEq(R"(Invalid Rational "a.1")")));
  EXPECT_THAT(
      [] { Rational("1.a"); },
      testing::ThrowsMessage<InvalidInputException>(
          testing::StrEq(R"(Invalid Rational "1.a")")));
  EXPECT_THAT(
      [] { Rational("1a.1"); },
      testing::ThrowsMessage<InvalidInputException>(
          testing::StrEq(R"(Invalid Rational "1a.1")")));
  EXPECT_THAT(
      [] { Rational("1.1a"); },
      testing::ThrowsMessage<InvalidInputException>(
          testing::StrEq(R"(Invalid Rational "1.1a")")));
  EXPECT_THAT(
      [] { Rational(".1."); },
      testing::ThrowsMessage<InvalidInputException>(
          testing::StrEq(R"(Invalid Rational ".1.")")));
  EXPECT_THAT(
      [] { Rational("--10.-1"); },
      testing::ThrowsMessage<InvalidInputException>(
          testing::StrEq(R"(Invalid Rational "--10.-1")")));
  EXPECT_THAT(
      [] { Rational("10.-1"); },
      testing::ThrowsMessage<InvalidInputException>(
          testing::StrEq(R"(Invalid Rational "10.-1")")));
  EXPECT_THAT(
      [] { Rational("1-0.1"); },
      testing::ThrowsMessage<InvalidInputException>(
          testing::StrEq(R"(Invalid Rational "1-0.1")")));
  EXPECT_THAT(
      [] { Rational("10-.1"); },
      testing::ThrowsMessage<InvalidInputException>(
          testing::StrEq(R"(Invalid Rational "10-.1")")));
  ...
  EXPECT_THAT(
      [] { Rational("1.10.1"); },
      testing::ThrowsMessage<InvalidInputException>(
          testing::StrEq(R"(Invalid Rational "1.10.1")")));
}
