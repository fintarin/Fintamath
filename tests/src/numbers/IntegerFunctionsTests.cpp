...
TEST(IntegerFunctionsTests, multinomialCoefficientTest) {
  ...
  EXPECT_THAT(
      [] { multinomialCoefficient(Integer(12), {Integer(3)}); },
      testing::ThrowsMessage<UndefinedException>(
          testing::StrEq("")));
  EXPECT_THAT(
      [] { multinomialCoefficient(Integer(12), {Integer(3), Integer(19), Integer(0)}); },
      testing::ThrowsMessage<UndefinedException>(
          testing::StrEq("")));
  EXPECT_THAT(
      [] { multinomialCoefficient(Integer(12), {Integer(0)}); },
      testing::ThrowsMessage<UndefinedException>(
          testing::StrEq("")));
  EXPECT_THAT(
      [] { multinomialCoefficient(Integer(-12), {Integer(3), Integer(9), Integer(0)}); },
      testing::ThrowsMessage<UndefinedException>(
          testing::StrEq("")));
  EXPECT_THAT(
      [] { multinomialCoefficient(Integer(12), {Integer(-3), Integer(9), Integer(0)}); },
