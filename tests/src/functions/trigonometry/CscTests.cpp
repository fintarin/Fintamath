...
TEST(CscTests, callTest) {
  ...
  EXPECT_EQ(f(getPi())->toString(),
            "1.0655913054451999575259851156676681900962706079459675565401060012426608022900275*10^121");
  ...
  EXPECT_EQ(f(-pow(Real(11), -100))->toString(),
            "-1.3780612339822270184118337172089636776264331200038466433146477552154985209552308*10^104");
  EXPECT_EQ(f(pow(Real(11), 100))->toString(),
            "csc(1.3780612339822270184118337172089636776264331200038466433146477552154985209552308*10^104)");
  EXPECT_EQ(f(-pow(Real(11), 100))->toString(),
            "csc(-1.3780612339822270184118337172089636776264331200038466433146477552154985209552308*10^104)");
