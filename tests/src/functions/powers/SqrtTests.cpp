...
TEST(SqrtTests, callTest) {
  ...
  EXPECT_EQ(Sqrt()(Integer(10)).toString(), "3.1622776601683793319988935444327185337195551393252168268575048527925944386392382");
  EXPECT_EQ(Sqrt()(Integer(10)).toString(), "3.1622776601683793319988935444327185337195551393252168268575048527925944386392382");
  EXPECT_EQ(Sqrt()(Rational(1, 10)).toString(), "0.31622776601683793319988935444327185337195551393252168268575048527925944386392382");
