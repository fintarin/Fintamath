...
TEST(AndTests, getTypeIdTest) {
  EXPECT_EQ(And::getTypeIdStatic(), MathObjectTypeId(MathObjectType::And));
  EXPECT_EQ(And().getTypeId(), MathObjectTypeId(MathObjectType::And));
}
