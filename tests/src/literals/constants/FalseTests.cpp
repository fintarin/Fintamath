...
TEST(FalseTests, getTypeIdTest) {
  EXPECT_EQ(False::getTypeIdStatic(), MathObjectTypeId(MathObjectType::False));
  EXPECT_EQ(False().getTypeId(), MathObjectTypeId(MathObjectType::False));
}
