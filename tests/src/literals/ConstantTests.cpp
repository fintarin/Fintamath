...
TEST(ConstantTest, toRationalTest) {
  EXPECT_EQ(Constant("e").toRational(1),
            Rational("2.71828182845904523536028747135266249775724709369995957496696762772407663035354759"));
  EXPECT_EQ(Constant("pi").toRational(1),
            Rational("3.14159265358979323846264338327950288419716939937510582097494459230781640628620899"));
  EXPECT_EQ(
      Constant("e").toRational(100),
      Rational(
          "2.7182818284590452353602874713526624977572470936999595749669676277240766303535475945713821785251664274"));
  EXPECT_EQ(
      Constant("pi").toRational(100),
      Rational(
