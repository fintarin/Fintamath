...
// class TestComparable : public IWithCompareOperators<TestComparable> {
//   FINTAMATH_CHILD_CLASS_BODY(TestComparable, IComparable)
...
// FINTAMATH_CHILD_CLASS_IMPLEMENTATION(TestComparable)
