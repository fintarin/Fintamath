...
TEST(MathObjectTests, cloneTest) {
  unique_ptr<IMathObject> m1 = make_unique<Integer>();
  unique_ptr<IMathObject> m2 = make_unique<Integer>(1);
  unique_ptr<IMathObject> m3 = m1->clone();
...
TEST(MathObjectTests, equalsTest) {
  unique_ptr<IMathObject> m1 = make_unique<Integer>(1);
  unique_ptr<IMathObject> m2 = make_unique<Rational>(1);
  unique_ptr<IMathObject> m3 = make_unique<Rational>(1, 2);
...
TEST(MathObjectTests, outputTest) {
  unique_ptr<IMathObject> m1 = make_unique<Integer>(123);
