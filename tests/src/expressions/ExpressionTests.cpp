...
TEST(ExpressionTests, stringConstructorTest) {
  ...
  EXPECT_EQ(Expression("sqrt(169/3)").toString(), "(13 sqrt(3))/3");
  ...
  EXPECT_EQ(Expression("sqr(3)").toString(), "9");
  ...
  EXPECT_EQ(Expression("root(x, x) mod 1").toString(), "root(x, x) mod 1");
  EXPECT_EQ(Expression("root(x, y/x) mod 1").toString(), "(x^(x/y)) mod 1");
  ...
  EXPECT_EQ(Expression("1 / (1 - tanh(2))").toString(), "cosh(2)/(cosh(2) - sinh(2))");
  EXPECT_EQ(Expression("1 / (1 - coth(2))").toString(), "sinh(2)/(sinh(2) - cosh(2))");
  ...
  EXPECT_EQ(Expression("derivative(2, x)").toString(), "0");
  EXPECT_EQ(Expression("derivative(2 + I, x)").toString(), "0");
  EXPECT_EQ(Expression("derivative(E, x)").toString(), "0");
  EXPECT_EQ(Expression("derivative(x, x)").toString(), "1");
  EXPECT_EQ(Expression("derivative(x, y)").toString(), "0");
  EXPECT_EQ(Expression("derivative(x_1, x_1)").toString(), "1");
  EXPECT_EQ(Expression("derivative(x_1, x_2)").toString(), "0");
  EXPECT_EQ(Expression("derivative(-x, x)").toString(), "-1");
  EXPECT_EQ(Expression("derivative(x + y, x)").toString(), "1");
  EXPECT_EQ(Expression("derivative(x + 2, x)").toString(), "1");
  EXPECT_EQ(Expression("derivative(x + (2+I), x)").toString(), "1");
  EXPECT_EQ(Expression("derivative(x - y, x)").toString(), "1");
  EXPECT_EQ(Expression("derivative(x - 2, x)").toString(), "1");
  EXPECT_EQ(Expression("derivative(x - (2+I), x)").toString(), "1");
  EXPECT_EQ(Expression("derivative(x * y, x)").toString(), "y");
  EXPECT_EQ(Expression("derivative(x * 2, x)").toString(), "2");
  EXPECT_EQ(Expression("derivative(x * (2+I), x)").toString(), "2 + I");
  EXPECT_EQ(Expression("derivative(x / y, x)").toString(), "1/y");
  EXPECT_EQ(Expression("derivative(y / x, x)").toString(), "-y/(x^2)");
  EXPECT_EQ(Expression("derivative(x / 2, x)").toString(), "1/2");
  EXPECT_EQ(Expression("derivative(2 / x, x)").toString(), "-2/(x^2)");
  EXPECT_EQ(Expression("derivative(x / (2+I), x)").toString(), "2/5 - 1/5 I");
  EXPECT_EQ(Expression("derivative((2+I) / x, x)").toString(), "-(2 + I)/(x^2)");
  EXPECT_EQ(Expression("derivative(x mod y, x)").toString(), "derivative(x mod y, x)");
  EXPECT_EQ(Expression("derivative(y mod x, x)").toString(), "derivative(y mod x, x)");
  EXPECT_EQ(Expression("derivative(x mod 2, x)").toString(), "derivative(x mod 2, x)");
  EXPECT_EQ(Expression("derivative(2 mod x, x)").toString(), "derivative(2 mod x, x)");
  EXPECT_EQ(Expression("derivative(x ^ x, x)").toString(), "x^x ln(x) + x^x");
  EXPECT_EQ(Expression("derivative(x ^ y, x)").toString(), "x^(y - 1) y");
  EXPECT_EQ(Expression("derivative(y ^ x, x)").toString(), "y^x ln(y)");
  EXPECT_EQ(Expression("derivative(x ^ 2, x)").toString(), "2 x");
  EXPECT_EQ(Expression("derivative(2 ^ x, x)").toString(), "2^x ln(2)");
  EXPECT_EQ(Expression("derivative(x ^ (3/5), x)").toString(), "3/(5 x^(2/5))");
  EXPECT_EQ(Expression("derivative((3/5) ^ x, x)").toString(), "(3/5)^x ln(3/5)");
  EXPECT_EQ(Expression("derivative(x ^ (-3/5), x)").toString(), "-3/(5 x^(8/5))");
  EXPECT_EQ(Expression("derivative((-3/5) ^ x, x)").toString(), "(-3/5)^x ln(-3/5)");
  EXPECT_EQ(Expression("derivative(x ^ (2+I), x)").toString(), "(2 + I) x^(1 + I)");
  EXPECT_EQ(Expression("derivative((2+I) ^ x, x)").toString(), "(2 + I)^x ln(2 + I)");
  EXPECT_EQ(Expression("derivative(x deg, x)").toString(), "Pi/180");
  EXPECT_EQ(Expression("derivative(x%, x)").toString(), "1/100");
  EXPECT_EQ(Expression("derivative(x!, x)").toString(), "derivative(x!, x)");
  EXPECT_EQ(Expression("derivative(sqrt(x), x)").toString(), "1/(2 sqrt(x))");
  EXPECT_EQ(Expression("derivative(root(x, 3), x)").toString(), "1/(3 x^(2/3))");
  EXPECT_EQ(Expression("derivative(root(x, 10), x)").toString(), "1/(10 x^(9/10))");
  EXPECT_EQ(Expression("derivative(exp(x), x)").toString(), "E^x");
  ...
  EXPECT_EQ(Expression("derivative(sec(x), x)").toString(), "sec(x)^2 sin(x)");
  EXPECT_EQ(Expression("derivative(sec(x^2), x)").toString(), "2 x sec(x^2)^2 sin(x^2)");
  EXPECT_EQ(Expression("derivative(csc(x), x)").toString(), "-csc(x)^2 cos(x)");
  EXPECT_EQ(Expression("derivative(csc(x^2), x)").toString(), "-2 x csc(x^2)^2 cos(x^2)");
  EXPECT_EQ(Expression("derivative(asin(x), x)").toString(), "1/sqrt(-x^2 + 1)");
  EXPECT_EQ(Expression("derivative(asin(x^2), x)").toString(), "(2 x)/sqrt(-x^4 + 1)");
  EXPECT_EQ(Expression("derivative(acos(x), x)").toString(), "-1/sqrt(-x^2 + 1)");
  EXPECT_EQ(Expression("derivative(acos(x^2), x)").toString(), "-(2 x)/sqrt(-x^4 + 1)");
  EXPECT_EQ(Expression("derivative(atan(x), x)").toString(), "1/(x^2 + 1)");
  ...
  EXPECT_EQ(Expression("derivative(cosh(x^2), x)").toString(), "2 x sinh(x^2)");
  EXPECT_EQ(Expression("derivative(tanh(x), x)").toString(), "sech(x)^2");
  EXPECT_EQ(Expression("derivative(tanh(x^2), x)").toString(), "2 x sech(x^2)^2");
  EXPECT_EQ(Expression("derivative(coth(x), x)").toString(), "-csch(x)^2");
  EXPECT_EQ(Expression("derivative(coth(x^2), x)").toString(), "-2 x csch(x^2)^2");
  EXPECT_EQ(Expression("derivative(sech(x), x)").toString(), "-sech(x)^2 sinh(x)");
  EXPECT_EQ(Expression("derivative(sech(x^2), x)").toString(), "-2 x sech(x^2)^2 sinh(x^2)");
  EXPECT_EQ(Expression("derivative(csch(x), x)").toString(), "-csch(x)^2 cosh(x)");
  EXPECT_EQ(Expression("derivative(csch(x^2), x)").toString(), "-2 x csch(x^2)^2 cosh(x^2)");
  EXPECT_EQ(Expression("derivative(asinh(x), x)").toString(), "1/sqrt(x^2 + 1)");
  EXPECT_EQ(Expression("derivative(asinh(x^2), x)").toString(), "(2 x)/sqrt(x^4 + 1)");
  EXPECT_EQ(Expression("derivative(acosh(x), x)").toString(), "1/(sqrt(x + 1) sqrt(x - 1))");
  EXPECT_EQ(Expression("derivative(acosh(x^2), x)").toString(), "(2 x)/(sqrt(x^2 + 1) sqrt(x^2 - 1))");
  EXPECT_EQ(Expression("derivative(atanh(x), x)").toString(), "-1/(x^2 - 1)");
  ...
  EXPECT_EQ(Expression("derivative(ceil(x), x)").toString(), "derivative(ceil(x), x)");
  EXPECT_EQ(Expression("derivative(min(x, y), x)").toString(), "derivative(min(x, y), x)");
  EXPECT_EQ(Expression("derivative(max(x, y), x)").toString(), "derivative(max(x, y), x)");
  EXPECT_EQ(Expression("derivative(integral(x!, x), x)").toString(), "derivative(integral(x!, x), x)");
  EXPECT_EQ(Expression("derivative(a b x, x)").toString(), "a b");
  EXPECT_EQ(Expression("derivative(a b c x, x)").toString(), "a b c");
  EXPECT_EQ(Expression("derivative(a x y, x)").toString(), "a y");
  EXPECT_EQ(Expression("derivative(x y z, x)").toString(), "y z");
  EXPECT_EQ(Expression("derivative(x y z z_1, x)").toString(), "y z z_1");
  ...
  EXPECT_EQ(Expression("derivative(x^5 (2 - x/3 + 3x^2), x)").toString(), "21 x^6 - 2 x^5 + 10 x^4");
  EXPECT_EQ(Expression("derivative(x^3 3^x, x)").toString(), "x^3*3^x ln(3) + 3 x^2*3^x");
  EXPECT_EQ(Expression("derivative(ln(3x + 5), x)").toString(), "3/(3 x + 5)");
  EXPECT_EQ(Expression("derivative(ln(x^5 - 2x^2 + 5), x)").toString(), "(5 x^4 - 4 x)/(x^5 - 2 x^2 + 5)");
  ...
  EXPECT_EQ(Expression("derivative(sin(x)/sinh(x), x)").toString(), "-csch(x)^2 sin(x) cosh(x) + cos(x) csch(x)");
  ...
  EXPECT_EQ(Expression("integral(x+x, x)").toString(), "integral(2 x, x)");
  EXPECT_EQ(Expression("integral(x, x) + integral(b, b)").toString(), "integral(b, b) + integral(x, x)");
  ...
  EXPECT_EQ(Expression("log(2.3, (E)/(20000.1*E*E)) - log(2.3, 20000.1*E)").toString(), "log(23/10, 100/(40000400001 E^2))");
  ...
  EXPECT_EQ(Expression("sin(x)^2 + sign(x)^2").toString(), "sin(x)^2 + sign(x)^2");
  EXPECT_EQ(Expression("sin(x)^2 - sign(x)^2").toString(), "sin(x)^2 - sign(x)^2");
  EXPECT_EQ(Expression("cos(x)^2 + sign(x)^2").toString(), "cos(x)^2 + sign(x)^2");
  EXPECT_EQ(Expression("cos(x)^2 - sign(x)^2").toString(), "cos(x)^2 - sign(x)^2");
  EXPECT_EQ(Expression("sign(x)^2 + 1").toString(), "sign(x)^2 + 1");
  EXPECT_EQ(Expression("sign(x)^2 - 1").toString(), "sign(x)^2 - 1");
  ...
  EXPECT_EQ(Expression("sign(I + 1)").toString(), "((1 + I) sqrt(2))/2");
  EXPECT_EQ(Expression("sign(3I + 2)").toString(), "((2 + 3 I) sqrt(13))/13");
  ...
  EXPECT_EQ(Expression("sqrt(3) (2/3 + 1/2 I)").toString(), "((4 + 3 I) sqrt(3))/6");
  EXPECT_EQ(Expression("I / x").toString(), "I/x");
  EXPECT_EQ(Expression("-I / x").toString(), "-I/x");
  EXPECT_EQ(Expression("2I / x").toString(), "(2 I)/x");
  EXPECT_EQ(Expression("-2I / x").toString(), "-(2 I)/x");
  EXPECT_EQ(Expression("(5/6 I) x").toString(), "(5 I x)/6");
  EXPECT_EQ(Expression("(5/6 I + 2/7) x").toString(), "((12 + 35 I) x)/42");
  EXPECT_EQ(Expression("(5/6 I + 2) x").toString(), "((12 + 5 I) x)/6");
  EXPECT_EQ(Expression("(5 I + 2/7) x").toString(), "((2 + 35 I) x)/7");
  EXPECT_EQ(Expression("(5/6 I) / x").toString(), "(5 I)/(6 x)");
  EXPECT_EQ(Expression("(5/6 I + 2/7) / x").toString(), "(12 + 35 I)/(42 x)");
  EXPECT_EQ(Expression("(5/6 I + 2) / x").toString(), "(12 + 5 I)/(6 x)");
  EXPECT_EQ(Expression("(5 I + 2/7) / x").toString(), "(2 + 35 I)/(7 x)");
  EXPECT_EQ(Expression("x / (5/6 I)").toString(), "-(6 I x)/5");
  EXPECT_EQ(Expression("x / (5/6 I + 2/7)").toString(), "((504 - 1470 I) x)/1369");
  EXPECT_EQ(Expression("x / (5/6 I + 2)").toString(), "((72 - 30 I) x)/169");
  EXPECT_EQ(Expression("x / (5 I + 2/7)").toString(), "((14 - 245 I) x)/1229");
  ...
  EXPECT_EQ(Expression("Inf/0").toString(), "ComplexInf");
  EXPECT_EQ(Expression("0/-Inf").toString(), "0");
  EXPECT_EQ(Expression("-Inf/0").toString(), "ComplexInf");
  EXPECT_EQ(Expression("0/ComplexInf").toString(), "0");
  EXPECT_EQ(Expression("ComplexInf/0").toString(), "ComplexInf");
  EXPECT_EQ(Expression("0 / (Inf x)").toString(), "0");
  EXPECT_EQ(Expression("(Inf/x) / 0").toString(), "ComplexInf");
  EXPECT_EQ(Expression("1/Inf - 1").toString(), "-1");
  EXPECT_EQ(Expression("Inf/2 - 1").toString(), "Inf");
  ...
  EXPECT_EQ(Expression("Inf * (Inf x)").toString(), "Inf x");
  EXPECT_EQ(Expression("Inf * (Inf/x)").toString(), "Inf/x");
  EXPECT_EQ(Expression("Inf / a").toString(), "Inf/a");
  EXPECT_EQ(Expression("Inf / 2").toString(), "Inf");
  EXPECT_EQ(Expression("Inf / -2").toString(), "-Inf");
  EXPECT_EQ(Expression("Inf / I").toString(), "-I Inf");
  EXPECT_EQ(Expression("Inf / (-I - 3)").toString(), "-((3 - I) Inf)/10");
  EXPECT_EQ(Expression("Inf^2").toString(), "Inf");
  ...
  EXPECT_EQ(Expression("(-Inf)^(2/3)").toString(), "Inf sign((-1)^(2/3))");
  ...
  EXPECT_EQ(Expression("2^Inf").toString(), "Inf");
  EXPECT_EQ(Expression("2^-Inf").toString(), "0");
  EXPECT_EQ(Expression("0.2^Inf").toString(), "0");
  EXPECT_EQ(Expression("0.2^-Inf").toString(), "Inf");
  EXPECT_EQ(Expression("Inf^Inf").toString(), "ComplexInf");
  EXPECT_EQ(Expression("(-Inf)^Inf").toString(), "ComplexInf");
  EXPECT_EQ(Expression("ComplexInf^Inf").toString(), "ComplexInf");
  EXPECT_EQ(Expression("0^(Inf/x)").toString(), "0^(Inf/x)");
  EXPECT_EQ(Expression("1^(Inf/x)").toString(), "1^(Inf/x)");
  EXPECT_EQ(Expression("sqrt(2) * Inf").toString(), "Inf");
  EXPECT_EQ(Expression("-sqrt(2) * Inf").toString(), "-Inf");
  EXPECT_EQ(Expression("sqrt(2) ^ Inf").toString(), "Inf");
  EXPECT_EQ(Expression("sqrt(0.5) ^ Inf").toString(), "0");
  EXPECT_EQ(Expression("sqrt(2) ^ (-Inf)").toString(), "0");
  EXPECT_EQ(Expression("sqrt(0.5) ^ (-Inf)").toString(), "Inf");
  EXPECT_EQ(Expression("Inf ^ sqrt(5)").toString(), "Inf");
  EXPECT_EQ(Expression("Inf ^ -sqrt(5)").toString(), "0");
  EXPECT_EQ(Expression("(-Inf) ^ sqrt(5)").toString(), "Inf sign((-1)^sqrt(5))");
  EXPECT_EQ(Expression("(-Inf) ^ -sqrt(5)").toString(), "0");
  ...
  EXPECT_EQ(Expression("Inf^I").toString(), "Undefined");
  EXPECT_EQ(Expression("(-Inf)^I").toString(), "Undefined");
  EXPECT_EQ(Expression("(ComplexInf)^I").toString(), "Undefined");
  EXPECT_EQ(Expression("1^Inf").toString(), "Undefined");
  EXPECT_EQ(Expression("1^-Inf").toString(), "Undefined");
  EXPECT_EQ(Expression("1^ComplexInf").toString(), "Undefined");
  EXPECT_EQ(Expression("x^ComplexInf").toString(), "Undefined");
  EXPECT_EQ(Expression("I^Inf").toString(), "Undefined");
  EXPECT_EQ(Expression("I^-Inf").toString(), "Undefined");
  EXPECT_EQ(Expression("I^ComplexInf").toString(), "Undefined");
  EXPECT_EQ(Expression("2^ComplexInf").toString(), "Undefined");
  EXPECT_EQ(Expression("0.2^ComplexInf").toString(), "Undefined");
  EXPECT_EQ(Expression("(x Inf)^0").toString(), "Undefined");
  EXPECT_EQ(Expression("0^(x Inf)").toString(), "Undefined");
  EXPECT_EQ(Expression("1^(x Inf)").toString(), "Undefined");
  ...
  EXPECT_EQ(Expression("0^0 * 0").toString(), "Undefined");
  EXPECT_EQ(Expression("0^0 / 0").toString(), "Undefined");
  EXPECT_EQ(Expression("0 / 0^0").toString(), "Undefined");
  EXPECT_EQ(Expression("0^0 / 0^0").toString(), "Undefined");
  EXPECT_EQ(Expression("(x/x - 1)^0 / 0^0").toString(), "Undefined");
  EXPECT_EQ(Expression("0/0 - 0/0").toString(), "Undefined");
  EXPECT_EQ(Expression("0/0 * 0").toString(), "Undefined");
  EXPECT_EQ(Expression("0/0 / 0").toString(), "Undefined");
  EXPECT_EQ(Expression("Inf / (Inf x)").toString(), "Undefined");
  EXPECT_EQ(Expression("(Inf x) / Inf").toString(), "Undefined");
  EXPECT_EQ(Expression("0 * (Inf x)").toString(), "Undefined");
  EXPECT_EQ(Expression("Inf^x").toString(), "Undefined");
  EXPECT_EQ(Expression("Inf^-x").toString(), "Undefined");
  EXPECT_EQ(Expression("x^Inf").toString(), "Undefined");
  EXPECT_EQ(Expression("(-x)^Inf").toString(), "Undefined");
  EXPECT_EQ(Expression("(Inf x) ^ 0").toString(), "Undefined");
  EXPECT_EQ(Expression("(Inf x) ^ Inf").toString(), "Undefined");
  EXPECT_EQ(Expression("0 ^ (Inf x)").toString(), "Undefined");
  EXPECT_EQ(Expression("Inf ^ (Inf x)").toString(), "Undefined");
  EXPECT_EQ(Expression("(Inf/x)^0").toString(), "Undefined");
  ...
  EXPECT_EQ(Expression("log(-Inf, ComplexInf)").toString(), "Undefined");
  EXPECT_EQ(Expression("log(x Inf, Inf)").toString(), "Undefined");
  EXPECT_EQ(Expression("log(Inf, x Inf)").toString(), "Undefined");
  EXPECT_EQ(Expression("log(0^0, 0^0)").toString(), "Undefined");
  EXPECT_EQ(Expression("log(sign(Inf), -sign(-Inf))").toString(), "Undefined");
  EXPECT_EQ(Expression("tan(Pi) * cot(Pi)").toString(), "Undefined");
  EXPECT_EQ(Expression("sign(ComplexInf)").toString(), "Undefined");
  EXPECT_EQ(Expression("root(2, 0)").toString(), "Undefined");
...
TEST(ExpressionTests, approximateTest) {
  ...
  EXPECT_EQ(Expression("cot(ln(2)^1000000000)").approximate().toString(), "cot(0.0)");
  EXPECT_EQ(Expression("sec(ln(2)^1000000000)").approximate().toString(), "1.0");
  EXPECT_EQ(Expression("csc(ln(2)^1000000000)").approximate().toString(), "csc(0.0)");
