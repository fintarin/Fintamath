...
Constant::Constant(const Constant &other) { this->constant = other.constant; }
...
const std::string Constant::toString() const { return this->toFraction().toString(PRECISION + ROUND_CONST / 2); }

const std::string Constant::getTypeName() const { return "Constant"; }
