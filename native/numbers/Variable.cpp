...
Variable::Variable(const Variable &other) { this->name = other.name; }
...
char Variable::getName() const { return this->name; }

const std::string Variable::getTypeName() const { return "Variable"; }
