...
Function::Function(const Function &other) { this->func = other.func; }
...
bool isType::isBinaryFunction(const std::string &inStr) { return (inStr == "log"); }
...
const std::string Function::getTypeName() const { return "Function"; }

const std::string Function::toString() const { return this->func; }
