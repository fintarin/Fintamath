...
function(set_project_warnings)
  ...
  set(CLANG_WARNINGS
      ...
      # Ignored warnings
      -Wno-multiple-move-vbase # warn on defaulted move assignment operator will move assign virtual base class multiple
                               # times
  )
  ...
  elseif(CMAKE_CXX_COMPILER_ID STREQUAL "GNU")
    ...
    message(WARNINGS "No compiler warnings set for '${CMAKE_CXX_COMPILER_ID}' compiler.")
  endif()
