...
NodePtr UnaryPlusOperator::operator()(const Integer &obj) const {
  return std::make_shared<Integer>(obj);
}

NodePtr UnaryPlusOperator::operator()(const Rational &obj) const {
  return std::make_shared<Rational>(obj);
}
